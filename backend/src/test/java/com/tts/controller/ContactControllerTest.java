...
public class ContactControllerTest {
    ...
    @Autowired
    private com.tts.repository.ContactSubmissionRepository contactSubmissionRepository;
    ...
    public void testContactSubmissionSupport() throws Exception {
        ...
        java.util.List<com.tts.entity.ContactSubmission> submissions = contactSubmissionRepository.findAll();
