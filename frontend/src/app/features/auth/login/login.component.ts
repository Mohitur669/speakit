          ...
          >
            ...
            <div class="p-8">
              <form (submit)="onSubmit()" class="space-y-6">
                ...
                @if (error()) {
                  <div
                    class="p-4 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/30"
                  >
              ...
              <p class="text-center text-primary-600 dark:text-primary-400">
                ...
                <a
                  ...
                  class="font-semibold text-brand-blue hover:text-brand-blue/80 transition-colors"
                  >Create one</a
                >
              </p>
            </div>
