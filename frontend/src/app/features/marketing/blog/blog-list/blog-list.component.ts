        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="max-w-3xl mb-16 animate-slide-up">
            ...
            <p class="text-xl text-primary-500 dark:text-primary-400 leading-relaxed">
              Honest technical breakdowns, architectural decisions, and the lessons learned while building SpeakIT.
            </p>
          </div>

          <!-- Featured Article -->
          <article *ngIf="posts.length > 0" [routerLink]="['/blog', posts[0].slug]" class="relative group cursor-pointer mb-16 animate-slide-up stagger-1">
            ...
            <div class="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div class="py-4">
                ...
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <div class="text-sm font-semibold text-primary-900 dark:text-white">{{ posts[0].author }}</div>
          ...
          <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 animate-slide-up stagger-2">
            ...
            <article *ngFor="let post of posts.slice(1)" [routerLink]="['/blog', post.slug]" class="group cursor-pointer">
              ...
              <div class="flex items-center gap-4 text-sm mb-3">
                <span [ngClass]="'text-' + post.categoryColor" class="font-semibold">{{ post.category }}</span>
