...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, NavbarComponent, FooterComponent, CustomDropdownComponent],
  template: `
          ...
          <div class="grid md:grid-cols-2 gap-16 lg:gap-24">
            ...
            <div class="animate-slide-up">
              <h1 class="text-4xl sm:text-5xl font-bold text-primary-900 dark:text-white mb-6">
                Get in <span class="inline-block text-transparent bg-clip-text bg-gradient-to-r from-brand-blue to-brand-purple">touch</span>
              </h1>
              ...
              <div class="space-y-8">
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-500 dark:text-primary-400 text-sm">support&#64;mohitur.com</p>
                  </div>
                </div>
                ...
                <div class="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p class="text-primary-500 dark:text-primary-400 text-sm">Interested in volume discounts? Select "Enterprise Sales" in Topic.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="animate-slide-up stagger-1">
              <div class="bg-white dark:bg-primary-900 rounded-2xl border border-primary-200 dark:border-primary-700 p-8 shadow-xl">
                <form (ngSubmit)="onSubmit()" #contactForm="ngForm" class="space-y-6">
                  ...
                  <div *ngIf="!success()" class="space-y-5">
                    ...
                    <div>
                      ...
                      <textarea name="message" [(ngModel)]="formData.message" required rows="4"
                        ...
                        class="w-full px-4 py-3 rounded-xl bg-primary-50 dark:bg-primary-800 border border-primary-200 dark:border-primary-700 text-primary-900 dark:text-white placeholder-primary-400 focus:outline-none focus:ring-2 focus:ring-brand-blue/50 focus:border-brand-blue transition-all resize-none"></textarea>
                    </div>

                    <!-- Honeypot Field (Hidden from humans) -->
                    <div class="hidden" aria-hidden="true">
                      <input type="text" name="website" [(ngModel)]="formData.website" tabindex="-1" autocomplete="off">
                    </div>
