  ...
  template: `
    <div 
      ...
      <div class="flex flex-col items-center gap-4">
        <div class="w-16 h-16 rounded-full bg-primary-100 dark:bg-primary-800 flex items-center justify-center text-primary-400 group-hover:text-brand-blue transition-colors">
          <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
          </svg>
        </div>

        <div *ngIf="!selectedFile(); else fileInfo">
          <h3 class="text-lg font-bold text-primary-900 dark:text-white mb-1">Drag and drop audio file</h3>
        ...
        <ng-template #fileInfo>
          <div>
            ...
            <p class="text-sm text-primary-500">{{ (selectedFile()?.size || 0) / 1024 / 1024 | number:'1.1-2' }} MB</p>
          </div>
        </ng-template>
