...
@Component({
  ...
  template: `
    <div class="min-h-screen bg-primary-50 dark:bg-primary-950 flex flex-col">
      ...
      <main class="flex-1 py-3 sm:py-6 md:py-8">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-center mb-4 sm:mb-6">
            <div
              class="inline-flex p-1 bg-primary-100/60 dark:bg-primary-900/40 rounded-2xl border border-primary-200/80 dark:border-primary-800/50 shadow-inner backdrop-blur-md relative select-none"
            >
              <!-- Sliding Highlight (Active Pill offset to STT) -->
              <div
                class="absolute top-1 bottom-1 left-[164px] sm:left-[184px] w-[160px] sm:w-[180px] rounded-xl bg-white dark:bg-primary-800 shadow-md shadow-primary-950/10 dark:shadow-[0_4px_12px_rgba(0,0,0,0.5)] border border-primary-200/30 dark:border-white/5 transition-all duration-300 ease-out"
              ></div>

              <!-- Text to Speech (Inactive) -->
              <a
                routerLink="/tts"
                class="relative z-10 flex items-center justify-center gap-2.5 w-[160px] sm:w-[180px] py-2.5 rounded-xl text-sm font-bold transition-all text-primary-500 hover:text-primary-900 dark:text-primary-400 dark:hover:text-white group"
              >
                <svg class="w-4 h-4 text-primary-400 dark:text-primary-500 group-hover:scale-110 group-hover:text-brand-blue transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button
                class="relative z-10 flex items-center justify-center gap-2.5 w-[160px] sm:w-[180px] py-2.5 rounded-xl text-sm font-bold transition-colors text-brand-blue"
              >
                <svg class="w-4 h-4 text-brand-blue animate-pulse-slow" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="mb-4 sm:mb-6 animate-slide-up">
            <h1
